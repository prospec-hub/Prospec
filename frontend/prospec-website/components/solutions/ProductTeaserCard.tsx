...
export const ProductTeaserCard = (props: ProductTeaserCardProps) => {
  const {
    ...
    dailyVolumeLabel = "OPERATIONS AUTOMATED DAILY",
    headline = "The Intelligence Layer for Modern Business",
    subheadline = "ProsPec eliminates operational complexity by combining AI, workflow automation, real-time analytics, and enterprise-grade security into one unified platform — so your team can focus on high-impact work.",
    description = "Built for speed. Designed for scale. Engineered for the future. Trusted by startups and enterprises to streamline workflows, improve collaboration, and make smarter business decisions.",
