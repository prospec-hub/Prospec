...
export const IntegrationCarousel = ({
  ...
  buttonHref = "#",
  title = "Connects with the tools your organization already uses.",
  subtitle = "Integrate CRMs, accounting software, communication platforms, cloud storage, HR systems, payment gateways, and custom APIs — for faster workflows and centralized data.",
