...
const stats: StatItem[] = [
  {
    value: "1B+",
    description: "Operations automated\ndaily",
    delay: 0,
  },
  {
    value: "99.9%",
  ...
  {
    value: "40%",
    description: "Average boost in\nteam productivity",
    delay: 0.4,
  },
  {
    value: "1000+",
    description: "Organizations running\non ProsPec",
    delay: 0.6,
  },
]
      ...
      <div className="mx-auto max-w-7xl px-8 py-24 pt-16">
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          <div className="col-span-12 md:col-span-6 relative z-10">
            ...
            >
              Running billions of operations daily{" "}
              <span
              ...
              >
                for startups, enterprises, and everyone scaling in between.
              </span>
            </h2>
            ...
            >
              Modern businesses rely on dozens of disconnected apps. ProsPec brings everything together in one
              intelligent workspace — so teams stop managing software and start growing the business.
            </p>
